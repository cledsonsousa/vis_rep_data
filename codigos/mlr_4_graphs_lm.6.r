...
plot1 <- ggplot(int00.lm.6, aes(.fitted, .resid)) +
  geom_point() +
...
plot2 <- ggplot(int00.lm.6, aes(sample = .stdresid)) +
  stat_qq() +
  stat_qq_line() +
...
plot3 <- ggplot(int00.lm.6, aes(.fitted, sqrt(abs(.stdresid)))) +
  geom_point() +
...
plot4 <- ggplot(int00.lm.6, aes(.hat, .stdresid)) +
