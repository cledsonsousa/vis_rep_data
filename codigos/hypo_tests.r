...
ggplot(dados, aes(x = x, y = y, color = Distribuicao)) +
  ...
  annotate("text", x = 4, y = 0.1, label = "Erro Tipo I\n(Rejeitar H0 quando H0 é verdadeira)", color = "red", hjust = 0, size = 4) +
  annotate("text", x = -2, y = 0.1, label = "Erro Tipo II\n(Não rejeitar H0 quando H1 é verdadeira)", color = "blue", hjust = 0, size = 4) +
