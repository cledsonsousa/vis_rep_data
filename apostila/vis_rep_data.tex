...
Experimentos na nossa área (Engenharia) tipicamente nos inundam com dados muitas vezes difíceis de entender e quiçá explicar. O objetivo aqui é escrutinar o método, a lógica, a arte e a prática da análise e representação de dados, fornecendo as habilidades e ferramentas essenciais para examinar dados e resolver problemas. Concordamos com a filosofia de "aprender fazendo" para uma melhor compreensão da análise de dados\footnote{Este capítulo foi fortemente baseado em \cite{brown2021statistics} de David Brown (ver Figura \ref{fig:mrbrown}) \emoji{backhand-index-pointing-down} .}.
...
\begin{figure}[htbp]
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figs/slr_resid_preciso_int_200}
	...
	\begin{subfigure}[b]{0.47\textwidth}
		\centering
		\includegraphics[width=\textwidth]{figs/slr_alavancagem_com_outlier_int_2000}
		\caption{Um gráfico de alavancagem para evidenciar os \textit{outliers} em um cenário em que realmente há \textit{outliers}, para  comparação Figura \ref{fig:slr4graphsint2000}.}
		\label{fig:figura_b}
	\end{subfigure}
	\caption{Dois gráficos que devem ser usados como comparação em cenários opostos as Figuras \ref{fig:slrresidint200} e \ref{fig:slr4graphsint2000}. }
...
%\begin{figure}[ht]
%	\centering
%	\includegraphics[width=0.7\linewidth]{figs/slr_resid_preciso_int_200}
%	\caption{Um modelo de regressão linear básico ajustado para uma precisão próxima de 90\%, para comparação com a Figura \ref{fig:slrresidint200}.}
